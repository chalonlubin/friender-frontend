    ...
    <div className="d-flex justify-content-center p-3">
      {loading ? (
        ...
        <div className="col-lg-6 col-10">
          <p className="text-center fs-3">Sign-up in just a few simple steps</p>
          <form
          ...
          >
            <div className="form-group">
              {err && <Alerts err={err} />}
              <label className="d-flex float-left mx-1 pt-3" htmlFor="username">
                <b>Username</b>
              </label>
              <input
                ...
                required
              />
              <label className="d-flex float-left mx-1 pt-3" htmlFor="password">
                <b>Password</b>
              </label>
              <input
                onChange={handleChange}
                ...
                required
              />
              <label className="d-flex float-left mx-1 pt-3" htmlFor="interests">
                <b>Interests</b>
              </label>
              <textarea
                onChange={handleChange}
              ...
              />
              <label className="d-flex flex-column float-left mx-1 pt-3" htmlFor="hobbies">
                <b>Hobbies</b>
              </label>
              <textarea
                onChange={handleChange}
              ...
              />
              <label className="d-flex flex-column float-left mx-1 pt-3" htmlFor="image">
                <b>Image</b>
              ...
              <input
                ...
                required
              />
              <label className="d-flex flex-column float-left mx-1 pt-3" htmlFor="location">
                <b>Zip Code</b>
                <p className="text-muted">We recommend 12345 for text users.</p>
              </label>
              <input
                onChange={handleChange}
                type="number"
                ...
                required
              />
              <label className="d-flex flex-column float-left mx-1 pt-3" htmlFor="radius">
